        ...
        <div className="borderless">
            <div className="borderless-info">
                ...
                <p className="borderless-info-text">
                    Empresas que derrubam barreiras e permitem o livre fluxo de informação são mais ágeis, inovadoras e competitivas.
                </p>
                <ul className="borderless-info-topics">
                    <li><span><FaCheck /></span>Agilidade na tomada decisões</li>
                    <li><span><FaCheck /></span>Compartilhamento de conhecimento</li>
            ...
            <div className="borderless-communication-card">
                ...
                <p className="borderless-communication-card-text">
                    Quando todos se conectam, a empresa cresce. Juntos, vamos mais longe!
                </p>
            </div>
        </div>
    )
